...
export interface AIStrategyConfig {
  ...
  risk_control: RiskControlConfig
  prompt_sections?: PromptSectionsConfig
  decision_weights?: DecisionWeightsConfig
...
export interface SentimentAnalysisConfig {
  enable_fear_greed_index: boolean
  enable_cryptoracle: boolean
  cryptoracle_api_key?: string
  cryptoracle_endpoints?: string[]
}
...
export interface RiskControlConfig {
  ...
  drawdown_min_profit?: number
  drawdown_max_drawdown?: number
}
