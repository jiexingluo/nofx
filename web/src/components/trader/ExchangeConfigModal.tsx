...
export function ExchangeConfigModal({
  ...
  const handleTestConnection = async () => {
    if (!currentExchangeType || currentExchangeType === 'hyperliquid') return
    setIsTesting(true)
    try {
      const result = await httpClient.post('/api/exchanges/test', {
        exchange_type: currentExchangeType,
        api_key: apiKey.trim(),
        ...
        lighter_wallet_addr: lighterWalletAddr.trim(),
        lighter_api_key_private_key: lighterApiKeyPrivateKey.trim(),
              ...
              {(currentExchangeType === 'binance' ||
                ...
                <>
                  ...
                  {editingExchangeId && selectedExchange && (
                    ...
                    >
                      Saved credential status: API Key{' '}
